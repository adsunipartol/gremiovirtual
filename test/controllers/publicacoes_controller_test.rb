...
class PublicacoesControllerTest < ActionController::TestCase
  ...
  test "should create publicacao" do
    assert_difference('Publicacao.count') do
      post :create, publicacao: { aluno_id: @publicacao.aluno_id, conteudo: @publicacao.conteudo, data: @publicacao.data, hora: @publicacao.hora, titulo: @publicacao.titulo }
    end
  ...
  test "should update publicacao" do
    patch :update, id: @publicacao, publicacao: { aluno_id: @publicacao.aluno_id, conteudo: @publicacao.conteudo, data: @publicacao.data, hora: @publicacao.hora, titulo: @publicacao.titulo }
    assert_redirected_to publicacao_path(assigns(:publicacao))
  end
